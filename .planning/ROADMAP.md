...
- [ ] 10-02-PLAN.md — Flink lexical core: quoting, literals, operators, identifiers + conflict-matrix snapshots

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 10-03-PLAN.md — Flink keyword classification per release + provenance attachments
