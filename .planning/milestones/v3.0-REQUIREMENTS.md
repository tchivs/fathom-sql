# Requirements: Doris SQL Parser SDK — v3.0 Analysis and Intelligence (DEFERRED)

> **DEFERRED 2026-08-06:** v2.0 was redefined as the Multi-Dialect milestone (Flink SQL & Neutral Naming). These analysis-layer requirements are carried forward to v3.0 and tracked in ROADMAP.md under "v3.0: Analysis and Intelligence — PLANNING (deferred)". The active v2.0 requirements live in `.planning/REQUIREMENTS.md`.
