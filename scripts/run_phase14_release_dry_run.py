...
def main():
    ...
    try:
        ...
        d = gh("workflow", "run", str(wf_id), "-R", "tchivs/fathom-sql",
               "--ref", branch, "-f", "tag=phase14-dry-run", "-f", "dry_run=true")
        ...
        # publication absence: no GitHub Release for the dry-run tag
        rel = gh("release", "view", "phase14-dry-run", "-R", "tchivs/fathom-sql")
